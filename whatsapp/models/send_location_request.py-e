...
class SendLocationRequest(ModelNormal):
    ...
    def __init__(self, lat, lng, address, _check_type=True, _from_server=False, _path_to_item=(), _configuration=None, **kwargs):  # noqa: E501
        """SendLocationRequest - a model defined in OpenAPI
        ...
        self.__set_item('lat', lat)
        self.__set_item('lng', lng)
        self.__set_item('address', address)
    ...
    def chat_id(self):
        ...
        **Required if phone is not set**  Chat ID from the message list. Examples: 17633123456@c.us for private messages and 17680561234-1479621234@g.us for the group. Used instead of the phone parameter.  # noqa: E501
        ...
        Returns:
            (str): The chat_id of this SendLocationRequest.  # noqa: E501
        """
        return self.__get_item('chat_id')

    @chat_id.setter
    def chat_id(self, value):
        """Sets the chat_id of this SendLocationRequest.  # noqa: E501
        **Required if phone is not set**  Chat ID from the message list. Examples: 17633123456@c.us for private messages and 17680561234-1479621234@g.us for the group. Used instead of the phone parameter.  # noqa: E501
        """
    ...
    def phone(self):
        ...
        **Required if chatId is not set**  A phone number starting with the country code. You do not need to add your number.   USA example: 17472822486.  # noqa: E501
        ...
        Returns:
            (int): The phone of this SendLocationRequest.  # noqa: E501
        """
        return self.__get_item('phone')

    @phone.setter
    def phone(self, value):
        """Sets the phone of this SendLocationRequest.  # noqa: E501
        **Required if chatId is not set**  A phone number starting with the country code. You do not need to add your number.   USA example: 17472822486.  # noqa: E501
        """
    ...
    def lat(self):
        ...
        Returns:
            (float): The lat of this SendLocationRequest.  # noqa: E501
        """
        return self.__get_item('lat')

    @lat.setter
    def lat(self, value):
        """Sets the lat of this SendLocationRequest.  # noqa: E501
        Latitude  # noqa: E501
        """
        return self.__set_item('lat', value)
    ...
    def lng(self):
        ...
        Returns:
            (float): The lng of this SendLocationRequest.  # noqa: E501
        """
        return self.__get_item('lng')

    @lng.setter
    def lng(self, value):
        """Sets the lng of this SendLocationRequest.  # noqa: E501
        Longitude  # noqa: E501
        """
        return self.__set_item('lng', value)
    ...
    def address(self):
        ...
        Returns:
            (str): The address of this SendLocationRequest.  # noqa: E501
        """
        return self.__get_item('address')

    @address.setter
    def address(self, value):
        """Sets the address of this SendLocationRequest.  # noqa: E501
        Text under the location.  Supports two lines. To use two lines, use the \"\\n\" symbol.  # noqa: E501
        """
        return self.__set_item('address', value)
