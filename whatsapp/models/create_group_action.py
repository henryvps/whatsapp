...
class CreateGroupAction(ModelNormal):
    ...
    def __init__(self, group_name, _check_type=True, _from_server=False, _path_to_item=(), _configuration=None, **kwargs):  # noqa: E501
        """CreateGroupAction - a model defined in OpenAPI
        ...
        self.__set_item('group_name', group_name)
    ...
    def group_name(self):
        ...
        Returns:
            (str): The group_name of this CreateGroupAction.  # noqa: E501
        """
        return self.__get_item('group_name')

    @group_name.setter
    def group_name(self, value):
        """Sets the group_name of this CreateGroupAction.  # noqa: E501
        Name of the group being created  # noqa: E501
        """
        return self.__set_item('group_name', value)
    ...
    def chat_ids(self):
        ...
        **Required if phones is not set**  An array of new participients chatIds.   # noqa: E501
        ...
        Returns:
            ([str]): The chat_ids of this CreateGroupAction.  # noqa: E501
        """
        return self.__get_item('chat_ids')

    @chat_ids.setter
    def chat_ids(self, value):
        """Sets the chat_ids of this CreateGroupAction.  # noqa: E501
        **Required if phones is not set**  An array of new participients chatIds.   # noqa: E501
        """
        return self.__set_item('chat_ids', value)
    ...
    def phones(self):
        ...
        **Required if chatIds is not set**  An array of phones starting with the country code. You do not need to add your number.   USA example: [17472822486'].  # noqa: E501
        ...
        Returns:
            ([int]): The phones of this CreateGroupAction.  # noqa: E501
        """
        return self.__get_item('phones')

    @phones.setter
    def phones(self, value):
        """Sets the phones of this CreateGroupAction.  # noqa: E501
        **Required if chatIds is not set**  An array of phones starting with the country code. You do not need to add your number.   USA example: [17472822486'].  # noqa: E501
        """
        return self.__set_item('phones', value)
    ...
    def message_text(self):
        ...
        Returns:
            (str): The message_text of this CreateGroupAction.  # noqa: E501
        """
        return self.__get_item('message_text')

    @message_text.setter
    def message_text(self, value):
        """Sets the message_text of this CreateGroupAction.  # noqa: E501
        The text of the message that will be sent to the group when it is created. If you do not set a parameter, the message will not be sent  # noqa: E501
        """
        return self.__set_item('message_text', value)
