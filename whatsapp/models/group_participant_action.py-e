...
class GroupParticipantAction(ModelNormal):
    ...
    def __init__(self, group_id, participant_chat_id, _check_type=True, _from_server=False, _path_to_item=(), _configuration=None, **kwargs):  # noqa: E501
        """GroupParticipantAction - a model defined in OpenAPI
        ...
        self.__set_item('group_id', group_id)
        self.__set_item('participant_chat_id', participant_chat_id)
    ...
    def group_id(self):
        ...
        Returns:
            (str): The group_id of this GroupParticipantAction.  # noqa: E501
        """
        return self.__get_item('group_id')

    @group_id.setter
    def group_id(self, value):
        """Sets the group_id of this GroupParticipantAction.  # noqa: E501
        Chat ID from the chat list. Examples: 19680561234-1479621234@g.us for the group.  # noqa: E501
        """
        return self.__set_item('group_id', value)
    ...
    def participant_chat_id(self):
        ...
        **Required if participantPhone is not set**  Chat ID from the message list. Examples: 17633123456@c.us. Used instead of the participantPhone parameter.  # noqa: E501
        ...
        Returns:
            (str): The participant_chat_id of this GroupParticipantAction.  # noqa: E501
        """
        return self.__get_item('participant_chat_id')

    @participant_chat_id.setter
    def participant_chat_id(self, value):
        """Sets the participant_chat_id of this GroupParticipantAction.  # noqa: E501
        **Required if participantPhone is not set**  Chat ID from the message list. Examples: 17633123456@c.us. Used instead of the participantPhone parameter.  # noqa: E501
        """
        return self.__set_item('participant_chat_id', value)
    ...
    def participant_phone(self):
        ...
        **Required if participantChatId is not set**  A phone number starting with the country code. You do not need to add your number.   USA example: 17472822486.  # noqa: E501
        ...
        Returns:
            (int): The participant_phone of this GroupParticipantAction.  # noqa: E501
        """
        return self.__get_item('participant_phone')

    @participant_phone.setter
    def participant_phone(self, value):
        """Sets the participant_phone of this GroupParticipantAction.  # noqa: E501
        **Required if participantChatId is not set**  A phone number starting with the country code. You do not need to add your number.   USA example: 17472822486.  # noqa: E501
        """
        return self.__set_item('participant_phone', value)
