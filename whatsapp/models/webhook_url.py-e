...
class WebhookUrl(ModelNormal):
    ...
    def __init__(self, webhook_url, _check_type=True, _from_server=False, _path_to_item=(), _configuration=None, **kwargs):  # noqa: E501
        """WebhookUrl - a model defined in OpenAPI
        ...
        self.__set_item('webhook_url', webhook_url)
    ...
    def webhook_url(self):
        ...
        Returns:
            (str): The webhook_url of this WebhookUrl.  # noqa: E501
        """
        return self.__get_item('webhook_url')

    @webhook_url.setter
    def webhook_url(self, value):
        """Sets the webhook_url of this WebhookUrl.  # noqa: E501
        Http or https URL for receiving notifications. For testing, we recommend using [our RequestBin](http://bin.chat-api.com).  # noqa: E501
        """
