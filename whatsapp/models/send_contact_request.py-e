...
class SendContactRequest(ModelNormal):
    ...
    def __init__(self, contact_id, _check_type=True, _from_server=False, _path_to_item=(), _configuration=None, **kwargs):  # noqa: E501
        """SendContactRequest - a model defined in OpenAPI
        ...
        self.__set_item('contact_id', contact_id)
    ...
    def chat_id(self):
        ...
        **Required if phone is not set**  Chat ID from the message list. Examples: 17633123456@c.us for private messages and 17680561234-1479621234@g.us for the group. Used instead of the phone parameter.  # noqa: E501
        ...
        Returns:
            (str): The chat_id of this SendContactRequest.  # noqa: E501
        """
        return self.__get_item('chat_id')

    @chat_id.setter
    def chat_id(self, value):
        """Sets the chat_id of this SendContactRequest.  # noqa: E501
        **Required if phone is not set**  Chat ID from the message list. Examples: 17633123456@c.us for private messages and 17680561234-1479621234@g.us for the group. Used instead of the phone parameter.  # noqa: E501
        """
    ...
    def phone(self):
        ...
        **Required if chatId is not set**  A phone number starting with the country code. You do not need to add your number.   USA example: 17472822486.  # noqa: E501
        ...
        Returns:
            (int): The phone of this SendContactRequest.  # noqa: E501
        """
        return self.__get_item('phone')

    @phone.setter
    def phone(self, value):
        """Sets the phone of this SendContactRequest.  # noqa: E501
        **Required if chatId is not set**  A phone number starting with the country code. You do not need to add your number.   USA example: 17472822486.  # noqa: E501
        """
    ...
    def contact_id(self):
        ...
        Returns:
            (str): The contact_id of this SendContactRequest.  # noqa: E501
        """
        return self.__get_item('contact_id')

    @contact_id.setter
    def contact_id(self, value):
        """Sets the contact_id of this SendContactRequest.  # noqa: E501
        Contact ID | Contact IDs array. Example: \"17633123456@c.us\" or [\"17633123456@c.us\", \"17633123457@c.us\"]  # noqa: E501
        """
        return self.__set_item('contact_id', value)
