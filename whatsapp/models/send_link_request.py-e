...
class SendLinkRequest(ModelNormal):
    ...
    def __init__(self, body, preview_base64, title, _check_type=True, _from_server=False, _path_to_item=(), _configuration=None, **kwargs):  # noqa: E501
        """SendLinkRequest - a model defined in OpenAPI
        ...
        self.__set_item('body', body)
        self.__set_item('preview_base64', preview_base64)
        self.__set_item('title', title)
    ...
    def chat_id(self):
        ...
        **Required if phone is not set**  Chat ID from the message list. Examples: 17633123456@c.us for private messages and 17680561234-1479621234@g.us for the group. Used instead of the phone parameter.  # noqa: E501
        ...
        Returns:
            (str): The chat_id of this SendLinkRequest.  # noqa: E501
        """
        return self.__get_item('chat_id')

    @chat_id.setter
    def chat_id(self, value):
        """Sets the chat_id of this SendLinkRequest.  # noqa: E501
        **Required if phone is not set**  Chat ID from the message list. Examples: 17633123456@c.us for private messages and 17680561234-1479621234@g.us for the group. Used instead of the phone parameter.  # noqa: E501
        """
    ...
    def phone(self):
        ...
        **Required if chatId is not set**  A phone number starting with the country code. You do not need to add your number.   USA example: 17472822486.  # noqa: E501
        ...
        Returns:
            (int): The phone of this SendLinkRequest.  # noqa: E501
        """
        return self.__get_item('phone')

    @phone.setter
    def phone(self, value):
        """Sets the phone of this SendLinkRequest.  # noqa: E501
        **Required if chatId is not set**  A phone number starting with the country code. You do not need to add your number.   USA example: 17472822486.  # noqa: E501
        """
    ...
    def body(self):
        ...
        Returns:
            (str): The body of this SendLinkRequest.  # noqa: E501
        """
        return self.__get_item('body')

    @body.setter
    def body(self, value):
        """Sets the body of this SendLinkRequest.  # noqa: E501
        HTTP or HTTPS link, for example *https://wikimedia.org*  # noqa: E501
        """
    ...
    def preview_base64(self):
        ...
        Returns:
            (str): The preview_base64 of this SendLinkRequest.  # noqa: E501
        """
        return self.__get_item('preview_base64')

    @preview_base64.setter
    def preview_base64(self, value):
        """Sets the preview_base64 of this SendLinkRequest.  # noqa: E501
        Base64-encoded file with mime data, for example *data:image/jpeg;base64,/9j/4AAQSkZJRgABAQ...* for link's preview  # noqa: E501
        """
        return self.__set_item('preview_base64', value)
    ...
    def title(self):
        ...
        Returns:
            (str): The title of this SendLinkRequest.  # noqa: E501
        """
        return self.__get_item('title')

    @title.setter
    def title(self, value):
        """Sets the title of this SendLinkRequest.  # noqa: E501
        Title for send link  # noqa: E501
        """
    ...
    def description(self):
        ...
        Returns:
            (str): The description of this SendLinkRequest.  # noqa: E501
        """
        return self.__get_item('description')

    @description.setter
    def description(self, value):
        """Sets the description of this SendLinkRequest.  # noqa: E501
        Description for send link  # noqa: E501
        """
        return self.__set_item('description', value)
