...
class ForwardMessageRequest(ModelNormal):
    ...
    def __init__(self, message_id, _check_type=True, _from_server=False, _path_to_item=(), _configuration=None, **kwargs):  # noqa: E501
        """ForwardMessageRequest - a model defined in OpenAPI
        ...
        self.__set_item('message_id', message_id)
    ...
    def chat_id(self):
        ...
        **Required if phone is not set**  Chat ID from the message list. Examples: 17633123456@c.us for private messages and 17680561234-1479621234@g.us for the group. Used instead of the phone parameter.  # noqa: E501
        ...
        Returns:
            (str): The chat_id of this ForwardMessageRequest.  # noqa: E501
        """
        return self.__get_item('chat_id')

    @chat_id.setter
    def chat_id(self, value):
        """Sets the chat_id of this ForwardMessageRequest.  # noqa: E501
        **Required if phone is not set**  Chat ID from the message list. Examples: 17633123456@c.us for private messages and 17680561234-1479621234@g.us for the group. Used instead of the phone parameter.  # noqa: E501
        """
    ...
    def phone(self):
        ...
        **Required if chatId is not set**  A phone number starting with the country code. You do not need to add your number.   USA example: 17472822486.  # noqa: E501
        ...
        Returns:
            (int): The phone of this ForwardMessageRequest.  # noqa: E501
        """
        return self.__get_item('phone')

    @phone.setter
    def phone(self, value):
        """Sets the phone of this ForwardMessageRequest.  # noqa: E501
        **Required if chatId is not set**  A phone number starting with the country code. You do not need to add your number.   USA example: 17472822486.  # noqa: E501
        """
    ...
    def message_id(self):
        ...
        Returns:
            (str): The message_id of this ForwardMessageRequest.  # noqa: E501
        """
        return self.__get_item('message_id')

    @message_id.setter
    def message_id(self, value):
        """Sets the message_id of this ForwardMessageRequest.  # noqa: E501
        Message ID | Message IDs array. Example: \"false_6590996758@c.us_3EB03104D2B84CEAD82F\" or [\"false_6590996758@c.us_3EB03104D2B84CEAD82F\", \"false_6590996758@c.us_3EB03104D2B84CEAD82G\"]  # noqa: E501
        """
        return self.__set_item('message_id', value)
