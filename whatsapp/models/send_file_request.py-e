...
class SendFileRequest(ModelNormal):
    ...
    def __init__(self, body, filename, _check_type=True, _from_server=False, _path_to_item=(), _configuration=None, **kwargs):  # noqa: E501
        """SendFileRequest - a model defined in OpenAPI
        ...
        self.__set_item('filename', filename)
    ...
    def chat_id(self):
        ...
        **Required if phone is not set**  Chat ID from the message list. Examples: 17633123456@c.us for private messages and 17680561234-1479621234@g.us for the group. Used instead of the phone parameter.  # noqa: E501
        ...
        Returns:
            (str): The chat_id of this SendFileRequest.  # noqa: E501
        """
        return self.__get_item('chat_id')

    @chat_id.setter
    def chat_id(self, value):
        """Sets the chat_id of this SendFileRequest.  # noqa: E501
        **Required if phone is not set**  Chat ID from the message list. Examples: 17633123456@c.us for private messages and 17680561234-1479621234@g.us for the group. Used instead of the phone parameter.  # noqa: E501
        """
    ...
    def phone(self):
        ...
        **Required if chatId is not set**  A phone number starting with the country code. You do not need to add your number.   USA example: 17472822486.  # noqa: E501
        ...
        Returns:
            (int): The phone of this SendFileRequest.  # noqa: E501
        """
        return self.__get_item('phone')

    @phone.setter
    def phone(self, value):
        """Sets the phone of this SendFileRequest.  # noqa: E501
        **Required if chatId is not set**  A phone number starting with the country code. You do not need to add your number.   USA example: 17472822486.  # noqa: E501
        """
    ...
    def body(self):
        ...
        Returns:
            (str): The body of this SendFileRequest.  # noqa: E501
        """
        return self.__get_item('body')

    @body.setter
    def body(self, value):
        """Sets the body of this SendFileRequest.  # noqa: E501
        HTTP link *https://upload.wikimedia.org/wikipedia/ru/3/33/NatureCover2001.jpg*  Or base64-encoded file with mime data, for example *data:image/jpeg;base64,/9j/4AAQSkZJRgABAQ...*   File in form-data input field  # noqa: E501
        """
    ...
    def filename(self):
        ...
        Returns:
            (str): The filename of this SendFileRequest.  # noqa: E501
        """
        return self.__get_item('filename')

    @filename.setter
    def filename(self, value):
        """Sets the filename of this SendFileRequest.  # noqa: E501
        File name, for *example 1.jpg* or *hello.xlsx*  # noqa: E501
        """
        return self.__set_item('filename', value)
    ...
    def caption(self):
        ...
        Returns:
            (str): The caption of this SendFileRequest.  # noqa: E501
        """
        return self.__get_item('caption')

    @caption.setter
    def caption(self, value):
        """Sets the caption of this SendFileRequest.  # noqa: E501
        Text under the file  # noqa: E501
        """
        return self.__set_item('caption', value)
